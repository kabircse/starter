						...
						<div id="comments" class="comments-area">
							<?php
									...
									$comment_args = array(
											...
											'author' => '<div class="form-group row">' . '<label for="author" class="col-sm-2 col-form-label">' . __( 'Name' ) . ( $req ? '<span>*<span/>' : '' ) . '</label> ' .
				              ...
				              '<label for="email" class="col-sm-2 col-form-label">' . __( 'Email' ) . ( $req ? '<span>*</span>' : '' ) . '</label> ' .
				              ...
				              '<label for="comment" class="col-sm-2 col-form-label">' . __( 'Comment' ) . ( $req ? '<span>*</span>' : '' ) .'</label>' .
							...
							if ( have_comments() ) : ?>
								<h3 class="comments-title">
									<?php
										printf( // WPCS: XSS OK.
											esc_html( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'starter' ) ),
